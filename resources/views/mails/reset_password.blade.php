...
<center style="width: 100%; background-color: #f1f1f1;">
    ...
    {{--</div>--}}
    <div style="min-height: 350px;" class="email-container">
        <!-- BEGIN BODY -->
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr style="background-color: white;" class="header_content">
                <td class="bg_white logo" style="text-align: center;width: 100%;">
            ...
            <tr>
                <td class="bg_white email-section">
                    <div class="heading-section" style="text-align: center; padding: 0 30px;">
                        <h2>Hello {{$name}}</h2>
                        <span>Your new password is: {{$password}}</span> <br/>
                    </div>
                </td>
            </tr><!-- end: tr -->
