                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="serial_number" value="{{ $asset->serial_number }}" placeholder="Enter serial numer" required>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label  class="form-label">MD Number:</label>
                                        <input type="text" class="form-control" name="md_number" value="{{ $asset->md_number }}" placeholder="Enter MD numer" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="grn_number" value="{{ $asset->grn_number }}" placeholder="Enter GRN numer" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="date_received" value="{{ $asset->date_received }}" required>
                                    </div>
                                </div>
