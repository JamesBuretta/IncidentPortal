...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Registered Companies</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('delete_company') }}" method="POST">
                                            ...
                                            <a class="btn btn-primary btn-sm" href="{{ route('edit_company', $company->id)}}" role="button" alt="Edit"><i class="fa fa-edit"></i></a>
